...
// /workforce/* route. Three sections — Dashboard / Crew / Org. The
// strip itself styles like a console subheading (mono caps + active
// underline in the wf-tertiary accent).

import { NavLink } from 'react-router-dom';

const links = [
  { to: '/workforce',         label: 'DASHBOARD', end: true  },
  { to: '/workforce/agents',  label: 'CREW',      end: false },
  { to: '/workforce/org',     label: 'ORG',       end: false },
];
