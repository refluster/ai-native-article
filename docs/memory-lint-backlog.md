...
| ML-006 | The R-5/R-10 truncation heuristic must treat a trailing emphasis-close (`*…。*` italic byline) as a complete ending; a terminal-glyph set that omits `*`/`_` turns every persona-byline article into a false C-1 violation and blocks all deploys. | e7fc028993e1 byline `*Elena は…ご確認ください。*` flagged as truncated; deploy runs #469/#470/#485 red 2026-06-10/11 (fix: unwrap trailing `[*_]+` before the glyph test, in truncation.mjs + Code.gs together) | 1 | watching | — |
