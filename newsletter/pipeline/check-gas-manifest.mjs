...
// canonical newsletter/gas/appsscript.json is missing.
//
// Background: .clasp.json sets rootDir="newsletter/gas", so `clasp push`
// uploads newsletter/gas/appsscript.json. A stray appsscript.json elsewhere (especially at
...
const CANONICAL = 'newsletter/gas/appsscript.json'
