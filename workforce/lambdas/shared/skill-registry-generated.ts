...
export const SKILL_REQUIRES: Record<string, readonly string[]> = {
  ...
  "issue-design": ["github.token", "workforce.dispatch_token"] as const,
  "issue-implement": ["github.token", "workforce.dispatch_token"] as const,
  "issue-triage": ["github.token", "workforce.dispatch_token"] as const,
  ...
  "research-study": ["github.token"] as const,
