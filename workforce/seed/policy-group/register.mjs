#!/usr/bin/env node
// One-shot registration of the Policy & Regulatory Affairs group (2026-06)
...
//   node workforce/seed/policy-group/register.mjs --dry-run   # no creds needed
//
// Env:
...
// reports_to, and the ICs all report to tessa.
const SLUGS = ["tessa", "grace", "ishaan", "astrid", "mei"];
const W3_CAP_USD = 160;
