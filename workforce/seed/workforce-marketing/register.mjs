#!/usr/bin/env node
// One-shot registration of the Product & Category Marketing hire (2026-07)
...
//   node workforce/seed/workforce-marketing/register.mjs --dry-run   # no creds needed
//
// Env:
...
// Single IC hire — Nico reports to the existing VP `celeste`, so no ordering
