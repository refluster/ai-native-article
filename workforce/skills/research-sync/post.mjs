#!/usr/bin/env node
// research-sync/post.mjs — deterministic write for the "research-sync" Cadence,
...
// improvement, observation}. A cross-desk research-craft note is
// beat-noticing, neither friction nor proposal — it is ALWAYS an observation;
// the constant lives here (the deterministic layer) so the LLM cannot
// mis-tag it.
