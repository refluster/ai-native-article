#!/usr/bin/env node
// red-team-audit/post.mjs — deterministic write for the "red-team-audit" Cadence,
...
// improvement, observation}. A weekly falsification verdict is adversarial
// noticing, never a gate — it is ALWAYS an observation; the constant lives
