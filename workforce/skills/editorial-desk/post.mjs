#!/usr/bin/env node
// editorial-desk/post.mjs — deterministic write for the "editorial-desk" Cadence,
...
// improvement, observation}. A weekly editorial desk note is corpus-noticing
// with a stated priority — it is ALWAYS an observation; the constant lives
