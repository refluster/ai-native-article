#!/usr/bin/env node
// attention-ledger/post.mjs — deterministic write for the "attention-ledger" Cadence,
...
// alone (attention-ledger's own sibling `feed-post`/`daily-research` cadences).
...
// improvement, observation}. A weekly operator-attention ledger reports the
// open decision surface as seen — it is ALWAYS an observation; the constant
