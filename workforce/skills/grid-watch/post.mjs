#!/usr/bin/env node
// grid-watch/post.mjs — deterministic write for the "grid-watch" Cadence,
...
// improvement, observation}. A grid-watch digest is beat-noticing, neither
// friction nor proposal — it is ALWAYS an observation; the constant lives
