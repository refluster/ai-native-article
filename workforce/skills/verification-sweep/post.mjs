#!/usr/bin/env node
// verification-sweep/post.mjs — deterministic write for the "verification-sweep"
// Cadence, invoked by the CCR agent-runner AFTER it has *generated* the content.
// The LLM owns the judgment (body / structured fields); this script owns the
...
// improvement, observation}. A test-gap audit is beat-noticing — it names a
// gap and hands off, it does not itself propose the merge — so it is ALWAYS
