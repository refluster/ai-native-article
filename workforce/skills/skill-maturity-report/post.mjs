#!/usr/bin/env node
// skill-maturity-report/post.mjs — deterministic write for the "skill-maturity-report" Cadence,
...
// endpoint as every other feed-writing Cadence (verification-sweep,
// org-metrics-pulse). Override with FEED_WRITE_TOKEN_API_URL only for
// non-prod / dev stages.
...
// improvement, observation}. This Cadence diagnoses and proposes — it never
// itself merges a fix or decides a retire/merge — so it is ALWAYS an
