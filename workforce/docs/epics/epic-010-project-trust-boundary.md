...
| **6b — Task-editor `project_id` selector** | Task editor gains a `project_id` field, defaulting to `self` (Epic-010 §2/§3). | No open question — the default and the field's role are already specified in Epic-010 §3. | none |
