...
**Status:** In-progress (2026-07-11). **Created:** 2026-07-07. **Owner:** Maya (PM). **Implemented by:** #447 (Story 1 — ADR-0019 MEMORY.md layer + fire-time layer-3.5 injection + `curate-agent-memory.mjs` writer + 5 pilot files). **Decision record:** [ADR-0019](../adr/adr-0019-agent-semantic-memory.md).
