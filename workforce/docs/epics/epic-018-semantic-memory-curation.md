...
**Status:** In-progress (2026-07-12). **Created:** 2026-07-07. **Owner:** Maya (PM). **Implemented by:** [#447](https://github.com/refluster/ai-native-article/pull/447) (ADR-0019 + agent-runner layer 3.5 fire-time injection), [#483](https://github.com/refluster/ai-native-article/pull/483) (Story 3 — `memory-curation` Cadence, ADR-0020), [#489](https://github.com/refluster/ai-native-article/pull/489) (Story 4 — dynamic `workforce.memory_write_token`, ADR-0021). **Decision record:** [ADR-0019](../adr/adr-0019-agent-semantic-memory.md), [ADR-0020](../adr/adr-0020-delegated-memory-curation.md), [ADR-0021](../adr/adr-0021-dynamic-memory-write-token.md).
