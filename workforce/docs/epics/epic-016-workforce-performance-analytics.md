...
| T6 | Epic status flip (`Draft → Accepted`) | gate | the `- **Status**:` line of `workforce/docs/epics/epic-*.md`, read from git history | counted | the epic's own directly-referenced stories — not their descendants |
