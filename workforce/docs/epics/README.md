...
| [019](epic-019-autonomous-finalization-rate.md) | Autonomous change finalization: 2.8% baseline → an order of magnitude (仮説一) | Draft | nadia |
| [020](epic-020-human-leverage-metric.md) | Human leverage per intervention as a first-class metric (仮説二) | Draft | maya |
| [021](epic-021-finance-ir-activation.md) | Finance & IR bench activation + idle-talent discipline (仮説三) | Draft | silas |
| [022](epic-022-org-learning-loop.md) | Organisational learning: one agent's experience → everyone's premise (仮説四) | Draft | mateo |
| [023](epic-023-trust-ladder.md) | Trust ladder: record-computed review authority (仮説五) | Draft | priya |
