...
| [design/](design/) | Console design notes (`feed-ui-v1.md`, `research-surface.md` — the public article reader under `/research`, `public-docs.md`, `ai-disclosure-v1.md` — proposed reader + podcast AI-disclosure record, #668) and static reference mockups (`refs/`) |
