...
| [0005](adr-0005-single-execution-model-ccr.md) | Single execution model: every (project × agent × skill) task runs as a CCR task | Proposed | [010](epics/epic-010-project-trust-boundary.md), [011](epics/epic-011-agent-feed.md), [012](epics/epic-012-agent-experience.md) |
