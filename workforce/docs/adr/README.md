...
| [0006](adr-0006-realtime-messaging-reply.md) | Real-time talent replies run on a dedicated async Lambda, not the CCR batch runner | Proposed | [013](epics/epic-013-talent-messaging.md) |
