...
| [0038](adr-0038-stats-cost-figure-invariant.md) | Narrow the "no cost figures" test invariant on `GET /stats` to match `GET /performance`'s already-shipped modelled-figure precedent; reaffirm it unchanged on the public `GET /public/workforce-summary` | Proposed | — |
