...
| [0007](adr-0007-agent-config-single-source.md) | Agent config is single-sourced from git; DDB holds only operational state | Proposed | [006](epics/epic-006-scalability.md), [007](epics/epic-007-agent-management-api.md) |
