...
| [0039](adr-0039-feed-post-same-day-recall-not-skip.md) | `feed-post` reads its own same-day posts and stops treating an earlier `daily-research` post as "already covered" — resolves the two cadences' content collision without a bindings edit or a cadence merge | Proposed | [011](../epics/epic-011-agent-feed.md), [015](../epics/epic-015-daily-research-cadence.md) |
