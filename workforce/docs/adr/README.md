...
| [0020](adr-0020-delegated-memory-curation.md) | Delegated memory curation: bounded token write for the memory profile block (POST /agents/{slug}/memory + shrink guard) | Proposed | [018](../epics/epic-018-semantic-memory-curation.md) |
