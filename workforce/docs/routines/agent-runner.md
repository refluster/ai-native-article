...
- [`pr-implement.md`](pr-implement.md), [`pr-review.md`](pr-review.md), [`pr-autopilot.md`](pr-autopilot.md) — peer routines for code work (also generic, fired by their own paths).
