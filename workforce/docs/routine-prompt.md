...
2. Read workforce/docs/routine-prompt.md.
...
- [`workforce/docs/routines/agent-runner.md`](routines/agent-runner.md) — the peer CCR routine for agent skill execution.
